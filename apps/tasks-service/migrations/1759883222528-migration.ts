...
export class Migration1759883222528 implements MigrationInterface {
    name = 'Migration1759883222528'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" character varying NOT NULL, "createdBy" character varying NOT NULL, "editedBy" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "deadline" TIMESTAMP NOT NULL, "creationDate" TIMESTAMP NOT NULL DEFAULT now(), "users" text, "priorityId" integer, "statusId" integer, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
